...
describe('Article reducer', () => {
  ...
  it('should properly update when fetchArticlesListSuccess is called', () => {
  ...
  it('should properly update when fetchArticlesList is called', () => {
    expect(articleReducer(mockedState, fetchArticlesList())).toEqual({
      ...mockedState,
      isFetching: true
    });
  });
  it('should properly update when fetchArticlesListFail is called', () => {
